...
class config_NN (config_prototype):
    def __init__(self, N_states, time_dependent):
        ...
        self.random_seeds = {'train': 7, 'generate': 900}
        ...
        self.Ns = {'train': 600, 'val': 100, 'test': 1000}
...
class setup_problem(problem_prototype):
    def __init__(self):
        ...
        self.threshold = 0.1*(self.theta1+self.theta2) + 0.05*min(self.theta1, self.theta2) + 1.25
    ...
    def aug_dynamics(self, t, X_aug):
        ...
        dist_diff = torch.sigmoid(-(torch.sqrt(((self.R - dx2) - dx1) ** 2 + (dy2 - dy1) ** 2) - self.threshold) * 5)
