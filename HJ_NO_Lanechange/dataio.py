...
class LaneHJI_Supervised(Dataset):
    def __init__(self, Hybrid_use, seed=0, rank=0, ):
        ...
        if not self.hybrid_use:
            ...
            data_path1 = current_dir + '/validation_scripts/train_data/data_train_lanechange_1_1_2000.mat'
            data_path2 = current_dir + '/validation_scripts/train_data/data_train_lanechange_1_5_2000.mat'
            data_path3 = current_dir + '/validation_scripts/train_data/data_train_lanechange_5_1_2000.mat'
            data_path4 = current_dir + '/validation_scripts/train_data/data_train_lanechange_5_5_2000.mat'
        else:
            # hybrid neural operator
            data_path1 = current_dir + '/validation_scripts/train_data/data_train_lanechange_1_1_1000.mat'
            data_path2 = current_dir + '/validation_scripts/train_data/data_train_lanechange_1_5_1000.mat'
            data_path3 = current_dir + '/validation_scripts/train_data/data_train_lanechange_5_1_1000.mat'
            data_path4 = current_dir + '/validation_scripts/train_data/data_train_lanechange_5_5_1000.mat'
        ...
        current_dir = os.path.dirname(os.path.abspath(__file__))
        data_path = current_dir + '/validation_scripts/train_data/lanechange_param_fun_40.mat'
    ...
    def __getitem__(self, idx):
        ...
        self.lb = torch.tensor([[0], [31], [-0.17], [17], [0], [33], [-0.15], [17]], dtype=torch.float32)
        self.ub = torch.tensor([[95], [37], [0.15], [26], [95], [39], [0.17], [26]], dtype=torch.float32)
...
class LaneHJI_Hybrid(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        boundary_values_1 = self.alpha * ((coords_1_hji[:, 1:2] + 1) * (95 - 0) / 2 + 0) - \
                            ((coords_1_hji[:, 2:3] + 1) * (37 - 31) / 2 + 31 - 37) ** 2 - \
                            100 * ((coords_1_hji[:, 3:4] + 1) * (0.15 - (-0.17)) / 2 + (-0.17) - 0) ** 2 - \
                            ((coords_1_hji[:, 4:5] + 1) * (26 - 17) / 2 + 17 - 18) ** 2
        boundary_values_2 = self.alpha * ((coords_2_hji[:, 1:2] + 1) * (95 - 0) / 2 + 0) - \
                            ((coords_2_hji[:, 2:3] + 1) * (39 - 33) / 2 + 33 - 33) ** 2 - \
                            100 * ((coords_2_hji[:, 3:4] + 1) * (0.17 - (-0.15)) / 2 + (-0.15) - 0) ** 2 - \
                            ((coords_2_hji[:, 4:5] + 1) * (26 - 17) / 2 + 17 - 18) ** 2
