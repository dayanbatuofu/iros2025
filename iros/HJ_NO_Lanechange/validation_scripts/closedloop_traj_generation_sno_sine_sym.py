...
if __name__ == '__main__':
    ...
    ckpt_path = './model/sine/model_sno_sine.pth'
    activation = 'sine'

    # Initialize and load the model
    model = modules_sno.SingleBVPNet(in_features=10, out_features=64, type=activation, mode='mlp',
    ...
    if save_data:
        save_path = 'closed_loop/HNO/closedloop_traj_sno_initial_' + str(policy1[N_choice]) + '_sine.mat'
