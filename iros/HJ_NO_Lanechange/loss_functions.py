...
def initialize_lane_HJI_supervised(dataset, Weight, alpha):
...
def initialize_lane_HJI_hyrid(dataset, Weight, alpha):
    def interaction_hji(model_output, gt):
        ...
        threshold_11 = torch.tensor([2.5], dtype=torch.float32).to(device)  # collision penalty threshold
        threshold_15 = torch.tensor([2.9], dtype=torch.float32).to(device)  # collision penalty threshold
        threshold_51 = torch.tensor([2.9], dtype=torch.float32).to(device)  # collision penalty threshold
        threshold_55 = torch.tensor([3.5], dtype=torch.float32).to(device)  # collision penalty threshold
        ...
        dx_11_11_sl = (x1[:, :num_sl, 1:2] + 1) * (95 - 0) / 2 + 0
        dy_11_11_sl = (x1[:, :num_sl, 2:3] + 1) * (37 - 31) / 2 + 31
        
        dx_11_15_sl = (x1[:, num_sl:2*num_sl, 1:2] + 1) * (95 - 0) / 2 + 0
        dy_11_15_sl = (x1[:, num_sl:2*num_sl, 2:3] + 1) * (37 - 31) / 2 + 31

        dx_11_51_sl = (x1[:, 2*num_sl:3*num_sl, 1:2] + 1) * (95 - 0) / 2 + 0
        dy_11_51_sl = (x1[:, 2*num_sl:3*num_sl, 2:3] + 1) * (37 - 31) / 2 + 31

        dx_11_55_sl = (x1[:, 3*num_sl:4*num_sl, 1:2] + 1) * (95 - 0) / 2 + 0
        dy_11_55_sl = (x1[:, 3*num_sl:4*num_sl, 2:3] + 1) * (37 - 31) / 2 + 31

        dx_11_11_hl = (x1[:, 4*num_sl:4*num_sl+num_hl, 1:2] + 1) * (95 - 0) / 2 + 0
        dy_11_11_hl = (x1[:, 4*num_sl:4*num_sl+num_hl, 2:3] + 1) * (37 - 31) / 2 + 31
        
        dx_11_15_hl = (x1[:, 4*num_sl+num_hl:4*num_sl+2*num_hl, 1:2] + 1) * (95 - 0) / 2 + 0
        dy_11_15_hl = (x1[:, 4*num_sl+num_hl:4*num_sl+2*num_hl, 2:3] + 1) * (37 - 31) / 2 + 31

        dx_11_51_hl = (x1[:, 4*num_sl+2*num_hl:4*num_sl+3*num_hl, 1:2] + 1) * (95 - 0) / 2 + 0
        dy_11_51_hl = (x1[:, 4*num_sl+2*num_hl:4*num_sl+3*num_hl, 2:3] + 1) * (37 - 31) / 2 + 31

        dx_11_55_hl = (x1[:, 4*num_sl+3*num_hl:, 1:2] + 1) * (95 - 0) / 2 + 0
        dy_11_55_hl = (x1[:, 4*num_sl+3*num_hl:, 2:3] + 1) * (37 - 31) / 2 + 31

        theta_11 = (x1[:, :, 3:4] + 1) * (0.15 - (-0.17)) / 2 + (-0.17)
        v_11 = (x1[:, :, 4:5] + 1) * (26 - 17) / 2 + 17

        # unnormalize the state for agent 2
        dx_12_11_sl = (x1[:, :num_sl, 5:6] + 1) * (95 - 0) / 2 + 0
        dy_12_11_sl = (x1[:, :num_sl, 6:7] + 1) * (39 - 33) / 2 + 33
        
        dx_12_15_sl = (x1[:, num_sl:2*num_sl, 5:6] + 1) * (95 - 0) / 2 + 0
        dy_12_15_sl = (x1[:, num_sl:2*num_sl, 6:7] + 1) * (39 - 33) / 2 + 33

        dx_12_51_sl = (x1[:, 2*num_sl:3*num_sl, 5:6] + 1) * (95 - 0) / 2 + 0
        dy_12_51_sl = (x1[:, 2*num_sl:3*num_sl, 6:7] + 1) * (39 - 33) / 2 + 33

        dx_12_55_sl = (x1[:, 3*num_sl:4*num_sl, 5:6] + 1) * (95 - 0) / 2 + 0
        dy_12_55_sl = (x1[:, 3*num_sl:4*num_sl, 6:7] + 1) * (39 - 33) / 2 + 33

        dx_12_11_hl = (x1[:, 4*num_sl:4*num_sl+num_hl, 5:6] + 1) * (95 - 0) / 2 + 0
        dy_12_11_hl = (x1[:, 4*num_sl:4*num_sl+num_hl, 6:7] + 1) * (39 - 33) / 2 + 33
        
        dx_12_15_hl = (x1[:, 4*num_sl+num_hl:4*num_sl+2*num_hl, 5:6] + 1) * (95 - 0) / 2 + 0
        dy_12_15_hl = (x1[:, 4*num_sl+num_hl:4*num_sl+2*num_hl, 6:7] + 1) * (39 - 33) / 2 + 33

        dx_12_51_hl = (x1[:, 4*num_sl+2*num_hl:4*num_sl+3*num_hl, 5:6] + 1) * (95 - 0) / 2 + 0
        dy_12_51_hl = (x1[:, 4*num_sl+2*num_hl:4*num_sl+3*num_hl, 6:7] + 1) * (39 - 33) / 2 + 33

        dx_12_55_hl = (x1[:, 4*num_sl+3*num_hl:, 5:6] + 1) * (95 - 0) / 2 + 0
        dy_12_55_hl = (x1[:, 4*num_sl+3*num_hl:, 6:7] + 1) * (39 - 33) / 2 + 33

        theta_12 = (x1[:, :, 7:8] + 1) * (0.17 - (-0.15)) / 2 + (-0.15)
        v_12 = (x1[:, :, 8:9] + 1) * (26 - 17) / 2 + 17

        # calculate the collision area lower and upper bounds
        dist_diff1_11_sl = (-(torch.sqrt((dx_12_11_sl - dx_11_11_sl) ** 2 + (dy_12_11_sl - dy_11_11_sl) ** 2)
                            - threshold_11) * 5).squeeze().reshape(-1, 1).to(device)
        dist_diff1_15_sl = (-(torch.sqrt((dx_12_15_sl - dx_11_15_sl) ** 2 + (dy_12_15_sl - dy_11_15_sl) ** 2)
                            - threshold_15) * 5).squeeze().reshape(-1, 1).to(device)
        dist_diff1_51_sl = (-(torch.sqrt((dx_12_51_sl - dx_11_51_sl) ** 2 + (dy_12_51_sl - dy_11_51_sl) ** 2)
                            - threshold_51) * 5).squeeze().reshape(-1, 1).to(device)
        dist_diff1_55_sl = (-(torch.sqrt((dx_12_55_sl - dx_11_55_sl) ** 2 + (dy_12_55_sl - dy_11_55_sl) ** 2)
                            - threshold_55) * 5).squeeze().reshape(-1, 1).to(device)
        dist_diff1_11_hl = (-(torch.sqrt((dx_12_11_hl - dx_11_11_hl) ** 2 + (dy_12_11_hl - dy_11_11_hl) ** 2)
                            - threshold_11) * 5).squeeze().reshape(-1, 1).to(device)
        dist_diff1_15_hl = (-(torch.sqrt((dx_12_15_hl - dx_11_15_hl) ** 2 + (dy_12_15_hl - dy_11_15_hl) ** 2)
                            - threshold_15) * 5).squeeze().reshape(-1, 1).to(device)
        dist_diff1_51_hl = (-(torch.sqrt((dx_12_51_hl - dx_11_51_hl) ** 2 + (dy_12_51_hl - dy_11_51_hl) ** 2)
                            - threshold_51) * 5).squeeze().reshape(-1, 1).to(device)
        dist_diff1_55_hl = (-(torch.sqrt((dx_12_55_hl - dx_11_55_hl) ** 2 + (dy_12_55_hl - dy_11_55_hl) ** 2)
                            - threshold_55) * 5).squeeze().reshape(-1, 1).to(device)
        ...
        # unnormalize the state for agent 1
        dx_21_11_sl = (x2[:, :num_sl, 5:6] + 1) * (95 - 0) / 2 + 0
        dy_21_11_sl = (x2[:, :num_sl, 6:7] + 1) * (37 - 31) / 2 + 31
        
        dx_21_15_sl = (x2[:, num_sl:2*num_sl, 5:6] + 1) * (95 - 0) / 2 + 0
        dy_21_15_sl = (x2[:, num_sl:2*num_sl, 6:7] + 1) * (37 - 31) / 2 + 31

        dx_21_51_sl = (x2[:, 2*num_sl:3*num_sl, 5:6] + 1) * (95 - 0) / 2 + 0
        dy_21_51_sl = (x2[:, 2*num_sl:3*num_sl, 6:7] + 1) * (37 - 31) / 2 + 31

        dx_21_55_sl = (x2[:, 3*num_sl:4*num_sl, 5:6] + 1) * (95 - 0) / 2 + 0
        dy_21_55_sl = (x2[:, 3*num_sl:4*num_sl, 6:7] + 1) * (37 - 31) / 2 + 31

        dx_21_11_hl = (x2[:, 4*num_sl:4*num_sl+num_hl, 5:6] + 1) * (95 - 0) / 2 + 0
        dy_21_11_hl = (x2[:, 4*num_sl:4*num_sl+num_hl, 6:7] + 1) * (37 - 31) / 2 + 31
        
        dx_21_15_hl = (x2[:, 4*num_sl+num_hl:4*num_sl+2*num_hl, 5:6] + 1) * (95 - 0) / 2 + 0
        dy_21_15_hl = (x2[:, 4*num_sl+num_hl:4*num_sl+2*num_hl, 6:7] + 1) * (37 - 31) / 2 + 31

        dx_21_51_hl = (x2[:, 4*num_sl+2*num_hl:4*num_sl+3*num_hl, 5:6] + 1) * (95 - 0) / 2 + 0
        dy_21_51_hl = (x2[:, 4*num_sl+2*num_hl:4*num_sl+3*num_hl, 6:7] + 1) * (37 - 31) / 2 + 31

        dx_21_55_hl = (x2[:, 4*num_sl+3*num_hl:, 5:6] + 1) * (95 - 0) / 2 + 0
        dy_21_55_hl = (x2[:, 4*num_sl+3*num_hl:, 6:7] + 1) * (26 - 17) / 2 + 17

        theta_21 = (x2[:, :, 7:8] + 1) * (0.15 - (-0.17)) / 2 + (-0.17)
        v_21 = (x2[:, :, 8:9] + 1) * (26 - 17) / 2 + 17

        # unnormalize the state for agent 2
        dx_22_11_sl = (x2[:, :num_sl, 1:2] + 1) * (95 - 0) / 2 + 0
        dy_22_11_sl = (x2[:, :num_sl, 2:3] + 1) * (39 - 33) / 2 + 33
        
        dx_22_15_sl = (x2[:, num_sl:2*num_sl, 1:2] + 1) * (95 - 0) / 2 + 0
        dy_22_15_sl = (x2[:, num_sl:2*num_sl, 2:3] + 1) * (39 - 33) / 2 + 33

        dx_22_51_sl = (x2[:, 2*num_sl:3*num_sl, 1:2] + 1) * (95 - 0) / 2 + 0
        dy_22_51_sl = (x2[:, 2*num_sl:3*num_sl, 2:3] + 1) * (39 - 33) / 2 + 33

        dx_22_55_sl = (x2[:, 3*num_sl:4*num_sl, 1:2] + 1) * (95 - 0) / 2 + 0
        dy_22_55_sl = (x2[:, 3*num_sl:4*num_sl, 2:3] + 1) * (39 - 33) / 2 + 33

        dx_22_11_hl = (x2[:, 4*num_sl:4*num_sl+num_hl, 1:2] + 1) * (95 - 0) / 2 + 0
        dy_22_11_hl = (x2[:, 4*num_sl:4*num_sl+num_hl, 2:3] + 1) * (39 - 33) / 2 + 33
        
        dx_22_15_hl = (x2[:, 4*num_sl+num_hl:4*num_sl+2*num_hl, 1:2] + 1) * (95 - 0) / 2 + 0
        dy_22_15_hl = (x2[:, 4*num_sl+num_hl:4*num_sl+2*num_hl, 2:3] + 1) * (39 - 33) / 2 + 33

        dx_22_51_hl = (x2[:, 4*num_sl+2*num_hl:4*num_sl+3*num_hl, 1:2] + 1) * (95 - 0) / 2 + 0
        dy_22_51_hl = (x2[:, 4*num_sl+2*num_hl:4*num_sl+3*num_hl, 2:3] + 1) * (39 - 33) / 2 + 33

        dx_22_55_hl = (x2[:, 4*num_sl+3*num_hl:, 1:2] + 1) * (95 - 0) / 2 + 0
        dy_22_55_hl = (x2[:, 4*num_sl+3*num_hl:, 2:3] + 1) * (39 - 33) / 2 + 33

        theta_22 = (x2[:, :, 3:4] + 1) * (0.17 - (-0.15)) / 2 + (-0.15)
        v_22 = (x2[:, :, 4:5] + 1) * (26 - 17) / 2 + 17

        # calculate the collision area lower and upper bounds
        dist_diff2_11_sl = (-(torch.sqrt((dx_22_11_sl - dx_21_11_sl) ** 2 + (dy_22_11_sl - dy_21_11_sl) ** 2)
                            - threshold_11) * 5).squeeze().reshape(-1, 1).to(device)
        dist_diff2_15_sl = (-(torch.sqrt((dx_22_15_sl - dx_21_15_sl) ** 2 + (dy_22_15_sl - dy_21_15_sl) ** 2)
                            - threshold_15) * 5).squeeze().reshape(-1, 1).to(device)
        dist_diff2_51_sl = (-(torch.sqrt((dx_22_51_sl - dx_21_51_sl) ** 2 + (dy_22_51_sl - dy_21_51_sl) ** 2)
                            - threshold_51) * 5).squeeze().reshape(-1, 1).to(device)
        dist_diff2_55_sl = (-(torch.sqrt((dx_22_55_sl - dx_21_55_sl) ** 2 + (dy_22_55_sl - dy_21_55_sl) ** 2)
                            - threshold_55) * 5).squeeze().reshape(-1, 1).to(device)
        dist_diff2_11_hl = (-(torch.sqrt((dx_22_11_hl - dx_21_11_hl) ** 2 + (dy_22_11_hl - dy_21_11_hl) ** 2)
                            - threshold_11) * 5).squeeze().reshape(-1, 1).to(device)
        dist_diff2_15_hl = (-(torch.sqrt((dx_22_15_hl - dx_21_15_hl) ** 2 + (dy_22_15_hl - dy_21_15_hl) ** 2)
                            - threshold_15) * 5).squeeze().reshape(-1, 1).to(device)
        dist_diff2_51_hl = (-(torch.sqrt((dx_22_51_hl - dx_21_51_hl) ** 2 + (dy_22_51_hl - dy_21_51_hl) ** 2)
                            - threshold_51) * 5).squeeze().reshape(-1, 1).to(device)
        dist_diff2_55_hl = (-(torch.sqrt((dx_22_55_hl - dx_21_55_hl) ** 2 + (dy_22_55_hl - dy_21_55_hl) ** 2)
                            - threshold_55) * 5).squeeze().reshape(-1, 1).to(device)
