...
from examples.choose_problem_collision_avoidance_nop import system, problem, config
...
tags = ['1_1', '1_2', '1_3', '1_4', '1_5', '2_2', '2_3', '2_4', '2_5', '3_3', '3_4', '3_5', '4_4', '4_5', '5_5', '5_1']
idx = 0  # change the case you choose

# change the seed number you want
# np.random.seed(config.random_seeds['generate'])
"train data"
# np.random.seed(1000*idx+387)
# np.random.seed(1000*idx+387+1)
...
problem.threshold = 0.1*(problem.theta1+problem.theta2) + 0.05*min(problem.theta1, problem.theta2) + 1.25

print(problem.theta1, problem.theta2, problem.threshold)
...
save_path = 'examples/' + system + '/data_' + data_type + f'_narrowroad_{tag}.mat'
print(save_path)
