...
from examples.choose_problem_lane_change_nop import system, problem, config
...
problem.threshold = 0.1*(problem.theta1+problem.theta2) + 0.05*min(problem.theta1, problem.theta2) + 2.25
...
save_path = 'examples/' + system + '/data_' + data_type + f'_lanechange_{tag}.mat'
print(save_path)
