...
problem.threshold = 0.1*(problem.theta1+problem.theta2) + 0.05*min(problem.theta1, problem.theta2) + 0.5
...
save_path = 'examples/' + system + '/data_' + data_type + f'_drone_{tag}.mat'
