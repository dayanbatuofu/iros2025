...
class DroneHJI_Supervised(Dataset):
    def __init__(self, seed=0, rank=0):
        ...
        if not self.hybrid_use:
            ...
            data_path1 = current_dir + '/validation_scripts/train_data/data_train_drone_1_1_2000.mat'
            data_path2 = current_dir + '/validation_scripts/train_data/data_train_drone_1_5_2000.mat'
            data_path3 = current_dir + '/validation_scripts/train_data/data_train_drone_5_1_2000.mat'
            data_path4 = current_dir + '/validation_scripts/train_data/data_train_drone_5_5_2000.mat'
        else:
            # hybrid neural operator
            data_path1 = current_dir + '/validation_scripts/train_data/data_train_drone_1_1_1000.mat'
            data_path2 = current_dir + '/validation_scripts/train_data/data_train_drone_1_5_1000.mat'
            data_path3 = current_dir + '/validation_scripts/train_data/data_train_drone_5_1_1000.mat'
            data_path4 = current_dir + '/validation_scripts/train_data/data_train_drone_5_5_1000.mat'
        ...
        current_dir = os.path.dirname(os.path.abspath(__file__))
        data_path = current_dir + '/validation_scripts/train_data/drone_param_fun_30.mat'
    ...
    def __getitem__(self, idx):
        ...
        self.lb = torch.tensor([[0], [0], [-2.2], [0.3], [0.3], [-2],
                                [0], [0], [-2.2], [0.3], [0.3], [-2]], dtype=torch.float32)
        self.ub = torch.tensor([[15.5], [15.5], [2.5], [4.5], [4.5], [2.2],
        ...
        groundtruth_costates1 = torch.cat((self.A_train1[:12, :].T, self.A_train2[:12, :].T,
                                           self.A_train3[:12, :].T, self.A_train4[:12, :].T), dim=0)
        groundtruth_costates2 = torch.cat((self.A_train1[12:, :].T, self.A_train2[12:, :].T,
                                           self.A_train3[12:, :].T, self.A_train4[12:, :].T), dim=0)
